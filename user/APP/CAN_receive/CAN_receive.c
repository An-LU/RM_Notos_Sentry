...
void CAN_CMD_CHASSIS(int16_t motor1)//, int16_t motor2, int16_t motor3, int16_t motor4)
{
    ...
    TxMessage.Data[2] = 0;//motor2 >> 8;
    TxMessage.Data[3] = 0;//motor2;
    TxMessage.Data[4] = 0;//motor3 >> 8;
    TxMessage.Data[5] = 0;//motor3;
    TxMessage.Data[6] = 0;//motor4 >> 8;
    TxMessage.Data[7] = 0;//motor4;
